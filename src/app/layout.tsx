...
export const metadata: Metadata = {
  title: "Professional Photography Services in Vadodara | Pixify Studio",  description: "Expert wedding, pre-wedding, portrait, and event photography in Vadodara. 4.9★ rated with 179+ reviews. Call +91 70160 80009 or book your photoshoot today.",  keywords: "photography Vadodara, wedding photographer, pre-wedding shoot, portrait photography, event photography, professional photographer near me",  metadataBase: new URL("https://pixifystudio.com"),
  alternates: {
    canonical: "https://pixifystudio.com"},
  openGraph: {
    title: "Pixify Studio - Professional Photography in Vadodara",    description: "Capture your precious moments with Vadodara's most trusted photography studio. Specializing in weddings, pre-wedding shoots, and professional portraits.",    url: "https://pixifystudio.com",    siteName: "Pixify Studio",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/bride-groom-taste-red-wedding-cake-standing-before-altar-night_8353-7092.jpg",        alt: "Professional Wedding Photography"},
    ],
    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "Pixify Studio - Photography Services in Vadodara",    description: "Professional wedding and event photography. Book your session today!",    images: ["http://img.b2bpic.net/free-photo/bride-groom-taste-red-wedding-cake-standing-before-altar-night_8353-7092.jpg"],
  },
  robots: {
    index: true,
    follow: true,
